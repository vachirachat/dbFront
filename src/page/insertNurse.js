...
const insertNurse = (props) => {
    ...
    function sendData(){
        let dataSend = { 'CaseID': caseID, 'NurseID': nurseID }
        let url = 'http://localhost:5000/case/insert/nurse'
    ...
    return (
        ...
        <div class='card border col-lg-11' style={{padding:'50px',border:'100px',borderRadius:'30px',marginBottom:'25px',boxShadow:'0 8px 6px -6px black'}}>
            ...
            <div class='row' style={{ marginLeft: '5px' }}>
                <h6 style={{ marginTop: '10px' }}>NurseID : </h6><input type="text" class="form-control form-control-sm col-lg-10" style={{ marginLeft: '30px' }} onChange={(e) => { setNurseID(e.target.value) }} />
            </div>
